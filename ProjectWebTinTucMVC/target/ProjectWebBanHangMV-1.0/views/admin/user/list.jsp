...
<c:url var="URLnews" value="/admin-user"></c:url>
    ...
    <html>
        ...
        <body>
            <div class="main-content">
                <form action="<c:url value="/admin-user"></c:url>" method="get" id="formSubmit">
...
//                        console.log(result)
                        window.location.href = "${URLnews}?page=1&maxPageItem=4&sortName=username&sortBy=desc&type=list&message=delete_success";
                    },
                    error: function (error) {
                        window.location.href = "${URLnews}?page=1&maxPageItem=4&sortName=username&sortBy=desc&type=list&message=error_system";
                    }
                });
            }
        </script>
